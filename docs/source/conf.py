...
htmlhelp_basename = 'PyLangAcqdoc'
...
latex_documents = [
  (master_doc, 'PyLangAcq.tex', 'PyLangAcq Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pylangacq', 'PyLangAcq Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PyLangAcq', 'PyLangAcq Documentation',
   author, 'PyLangAcq', 'One line description of project.',
   'Miscellaneous'),
]
